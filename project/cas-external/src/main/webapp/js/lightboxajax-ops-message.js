...
AjaxLightbox.prototype = {
    ...
    initialize: function() {
        ...
        objBody.appendChild(Builder.node('div',{id:'lightboxAjax'}, [
            ...
            Builder.node('div',{id:'outerContentContainerOperation'}, [
                ...
                Builder.node('div',{id:'contentContainer'}, [
					...
					Builder.node('div',{id:'contentPanelmin',style:'display:none'}),
        ...
        (function(){
            var ids =
                'contentOverlayOperation lightboxAjax outerContentContainerOperation contentContainer contentPanelmin lightboxImage hoverNav contentLoading loadingLink ' +
	...
	new Ajax.Updater(this.contentPanelmin, link, {
		method: 'GET',
        ...
        this.resizeImageContainer(450, 190);
    ...
    //
        ...
        this.resizeImageContainer(200, 200);
