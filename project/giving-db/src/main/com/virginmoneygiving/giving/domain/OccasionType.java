...
public class OccasionType extends BaseAuditAttributes implements Serializable {

    /** Serial Version UID. */
    private static final long serialVersionUID = -1979726999869930704L;

    /** The code for the occasion type. */
    private String code;

    /** The description for the occasion. */
     ...
     */
     ...
     public String toString() {
        ...
        final String tab = "    ";
        return new StringBuilder("OccasionType ( ")
