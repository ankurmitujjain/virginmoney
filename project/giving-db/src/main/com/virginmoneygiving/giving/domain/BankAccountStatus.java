...
public class BankAccountStatus extends BaseAuditAttributes implements Serializable {

    /** serial version UID. */
    private static final long serialVersionUID = 5896589655656L;

    /** Code for bank account status code. */
    private String code;

    /** Description for bank account status description. */
    ...
    public String toString() {
        ...
        return new StringBuilder("BankAccountStatus ( ").append("code = ")
