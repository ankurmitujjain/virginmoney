 ...
 *         &lt;element name="regularDonation" type="{http://www.virginmoneygiving.com/type/payment-management/}DonationDistribution" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "createRegularWebDonationRequest")
public class CreateRegularWebDonationRequest {
    ...
    @XmlElement(required = true)
    protected List<DonationDistribution> regularDonation;
    ...
    /**
     * Gets the value of the regularDonation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the regularDonation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRegularDonation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<DonationDistribution> getRegularDonation() {
        if (regularDonation == null) {
            regularDonation = new ArrayList<DonationDistribution>();
        }
        return this.regularDonation;
    }
