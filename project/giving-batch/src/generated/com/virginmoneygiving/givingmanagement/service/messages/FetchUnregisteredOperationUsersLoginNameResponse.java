...
@XmlRootElement(name = "fetchUnregisteredOperationUsersLoginNameResponse", namespace = "http://www.virginmoneygiving.com/type/giving-management/common/")
public class FetchUnregisteredOperationUsersLoginNameResponse {
