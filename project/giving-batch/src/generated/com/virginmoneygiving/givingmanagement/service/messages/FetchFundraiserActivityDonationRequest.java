 ...
 *         &lt;element name="rowNumberLimit" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "FetchFundraiserActivityDonationRequest", namespace = "http://www.virginmoneygiving.com/type/giving-management/donor/")
public class FetchFundraiserActivityDonationRequest {
    ...
    /**
     * Gets the value of the rowNumberLimit property.
     * 
     */
    public int getRowNumberLimit() {
        return rowNumberLimit;
    }

    /**
     * Sets the value of the rowNumberLimit property.
     * 
     */
    public void setRowNumberLimit(int value) {
        this.rowNumberLimit = value;
    }
