...
@XmlRootElement(name = "fetchVMGUserDetailsForInternalUserResponse", namespace = "http://www.virginmoneygiving.com/type/giving-management/common/")
public class FetchVMGUserDetailsForInternalUserResponse {
