...
/**
 * Class to create the summary report of failed web donations by grouping them
 * according to the card type.
 * 
 * @author John Allen
 */
public class WebDonationPaymentFailedXMLWriter extends StaxEventItemWriter implements
        StepExecutionListener, ItemWriteListener {

    /** Instance for Logger. * */
    private static Logger LOGGER =
            Logger.getLogger(WebDonationPaymentFailedXMLWriter.class);
