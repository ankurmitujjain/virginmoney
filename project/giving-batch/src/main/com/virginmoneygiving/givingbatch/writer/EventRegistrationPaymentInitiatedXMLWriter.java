...
/**
 * Class to create the summary report of initiated event registrations by grouping them
 * according to the card type.
 * 
 * @author Yogesh Salunkhe
 */
public class EventRegistrationPaymentInitiatedXMLWriter extends
        StaxEventItemWriter implements StepExecutionListener, ItemWriteListener {

    /** Instance for Logger. * */
    private static Logger LOGGER =
            Logger.getLogger(EventRegistrationPaymentInitiatedXMLWriter.class);
    ...
    public void write(List list) throws XmlMappingException, IOException {
        ...
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace("EventRegistrationPaymentInitiatedXMLWriter::write() - START");
        }
        ...
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace("EventRegistrationPaymentInitiatedXMLWriter::write() - END");
        }
    }
    ...
    public void afterWrite(List list) {
        ...
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace("EventRegistrationPaymentInitiatedXMLWriter::afterWrite() - START");
        }
        DonationPaymentInitiatedBatch donationPaymentInitiatedBatch =
                new DonationPaymentInitiatedBatch();
		...
		MessageHeader messageHeader =
		        Util
		                .getMessageHeaderObject(MasterDataCodeConstants.EventRegistrationFee.EVENT_REG_FEE_PAYMENT_INITIATED
		                        .getCode());
        ...
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace("EventRegistrationPaymentInitiatedXMLWriter::afterWrite() - END");
        }
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("EventRegistrationPaymentInitiatedXMLWriter : Inside afterStep method " + stepExecution);
        }
    ...
    public void beforeStep(StepExecution stepExecution) {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("EventRegistrationPaymentInitiatedXMLWriter :Inside before step  execution context:" + stepExecution);
        }
