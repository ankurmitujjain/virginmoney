...
/**
 * This class is an Item Processor for the RegularDonationPaymentInitiatedProcessor batch.
 ...
 */
public class RegularDonationPaymentInitiatedProcessor implements
        ItemProcessor<Payment, Payment> {

    /** Instance of logger. * */
    private static Logger LOGGER =
            Logger.getLogger(RegularDonationPaymentInitiatedProcessor.class);
    ...
    public Payment process(Payment payment) throws GivingBatchException {
        if(LOGGER.isTraceEnabled()) {
            LOGGER.trace("RegularDonationPaymentInitiatedProcessor.process - Start");
        }
        ...
        if(LOGGER.isTraceEnabled()) {
            LOGGER.trace("RegularDonationPaymentInitiatedProcessor.process - End");
        }
        return payment;
