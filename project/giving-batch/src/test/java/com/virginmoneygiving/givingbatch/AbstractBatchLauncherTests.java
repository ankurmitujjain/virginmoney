/*
 * Copyright 2006-2007 the original author or authors. Licensed under the Apache
...
public abstract class AbstractBatchLauncherTests extends
    ...
    // private static final String CONTAINER_DEFINITION_LOCATION =
    ...
    protected String[] getConfigLocations() {
        return new String[] { ClassUtils.addResourcePathToPackagePath(
                getClass(), ClassUtils.getShortName(getClass())
                        + "-context.xml") };
