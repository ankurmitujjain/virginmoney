...
LightboxOptions = Object.extend({
    ...
    fileBottomNavCloseImage: '/Images/close_tcm21-25467.png',
...
AjaxLightbox.prototype = {
    ...
    initialize: function() {
		...
		$('contentOverlay').hide().observe('click', (function() { this.end(); }).bind(this));
        ...
        (function(){
            var ids =
                'contentOverlay lightboxAjax outerContentContainer contentContainer contentPanel lightboxImage hoverNav contentLoading loadingLink ' +
    ...
    start: function(contentLink) {
        ...
        $('contentLoading').show();
        new Effect.Appear(this.contentOverlay, { duration: this.overlayDuration, from: 0.0, to: LightboxOptions.overlayOpacity });
    ...
    resizeImageContainer: function(imgWidth, imgHeight) {
        ...
        new Effect.Scale(this.outerContentContainer, yScale, {scaleX: false, duration: this.resizeDuration, queue: 'front'});
        new Effect.Scale(this.outerContentContainer, xScale, {scaleY: false, duration: this.resizeDuration, delay: this.resizeDuration, afterFinish: function() {
        $("contentPanel").show()
		$('contentLoading').hide();
        }});		
    ...
    //
        ...
        new Effect.Fade(this.contentOverlay, { duration: this.overlayDuration });
