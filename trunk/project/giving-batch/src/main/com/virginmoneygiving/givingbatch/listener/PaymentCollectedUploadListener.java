...
/**
 * This class is used to make a gliss call for PaymentCollected job.
 * In case of failure entire batch operation will be roll back.
 *  
 * @author Tarun Adiwal
 */
public class PaymentCollectedUploadListener extends
    StepExecutionListenerSupport implements ItemWriteListener {

    /** create instance of logger. */
    private static final Logger LOGGER =
        Logger.getLogger(PaymentCollectedUploadListener.class);
    ...
    public void afterWrite(List ignored) {
        LOGGER
            .info("Inside PaymentCollectedUploadListener afterWrite method -Start");
        ...
        if (executionContext != null) {
            ...
            Batch batch = Util.getBatchObject(Constant.PAYMENT_COLLECTED, batchNumber);
            donationPaymentCollectedBatch.setBatch(batch);
            MessageHeader messageHeader = Util.getMessageHeaderObject(Constant.PAYMENT_COLLECTED);
        ...
        LOGGER
            .info("Inside PaymentCollectedUploadListener afterWrite method -Stop");
    }
