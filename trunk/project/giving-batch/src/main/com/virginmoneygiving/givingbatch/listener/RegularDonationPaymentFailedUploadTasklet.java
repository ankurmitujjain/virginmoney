...
/**
 * This class is used to make a gliss call RegularDonationPaymentFailed.
 * In case of failure entire batch operation will be roll back.
 *
 * @author Yogesh Salunkhe
 */
public class RegularDonationPaymentFailedUploadTasklet extends
    StepExecutionListenerSupport implements Tasklet {

    /** Create instance of logger. */
    private static final Logger LOGGER =
        Logger.getLogger(RegularDonationPaymentFailedUploadTasklet.class);
     ...
     * Send batch to GLIS.
     * 
     * @param stepExecution the execution context
     * 
    ...
    public RepeatStatus execute(StepContribution stepContribution,
        ...
        if(LOGGER.isTraceEnabled()) {
            LOGGER
                .trace("Inside RegularDonationPaymentFailedUploadTasklet execute method -Start");
        }
        ...
        if (executionContext != null) {
            List<FailedPayment> regularDonationPaymentFailedList =
                (List<FailedPayment>) executionContext
                    .get(Constant.REGULAR_DONATION_PAYMENT_FAILED_OBJECT_LIST);
            if (regularDonationPaymentFailedList != null) {
                failedDonationPaymentBatch
                    .setFailedPayment(regularDonationPaymentFailedList);
            }
        }
        batchDelegate
        ...
        if(LOGGER.isTraceEnabled()) {
            LOGGER
                .trace("Inside RegularDonationPaymentFailedUploadTasklet execute method -End");
        }
