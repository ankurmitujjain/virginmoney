...
/**
 * This class is an Item Processor for the PaymentCollectedItemProcessor batch.
 ...
 */
public class PaymentCollectedItemProcessor implements
        ItemProcessor<Payment, Payment> {

    /** instance for logger. * */
    private static Logger LOGGER =
            Logger.getLogger(PaymentCollectedItemProcessor.class);
    ...
    public Payment process(Payment payment) throws GivingBatchException {
        if(LOGGER.isTraceEnabled()) {
            LOGGER.trace("PaymentCollectedItemProcessor.process - Start");
        }
        ...
        if(LOGGER.isTraceEnabled()) {
            LOGGER.trace("PaymentCollectedItemProcessor.process - End");
        }
        return payment;
