...
/**
 * This class is used to make a gliss call for RegularDonationTransactionChargePaid.
 * In case of failure entire batch operation will be roll back.
 *
 * @author Tarun Adiwal
 */
public class RegularDonationTransactionChargePaidUploadListener extends
    StepExecutionListenerSupport implements ItemWriteListener {

    /** create instance of logger. */
    private static final Logger LOGGER =
        Logger
            .getLogger(RegularDonationTransactionChargePaidUploadListener.class);
    ...
    public void afterWrite(List ignored) {
        LOGGER
            .info("inside RegularDonationTransactionChargePaidUploadListener afterWrite method -Start");
        ...
        Batch batch = Util.getBatchObject(Constant.REGULAR_DONATION_TRANSACTION_CHARGE_PAID, batchNumber);
        transactionChargePaidBatch.setBatch(batch);
        MessageHeader messageHeader = Util.getMessageHeaderObject(Constant.REGULAR_DONATION_TRANSACTION_CHARGE_PAID);
        ...
        LOGGER
            .info("inside RegularDonationTransactionChargePaidUploadListener afterWrite method -End");
    }
