...
/**
 * This class is used to make a gliss call for EventRegistrationFeePaymentCollected job.
 * In case of failure entire batch operation will be roll back.
 * 
 * @author Tarun Adiwal
 */
public class EventRegistrationFeePaymentCollectedUploadListener extends StepExecutionListenerSupport
        implements ItemWriteListener {

    /** create instance of logger. */
    private static final Logger LOGGER =
            Logger
                    .getLogger(EventRegistrationFeePaymentCollectedUploadListener.class);
    ...
    public void afterWrite(List ignored) {
        LOGGER
        .info("Inside EventRegistrationFeePaymentCollectedUploadListener afterWrite method -Start");
        ...
        if (executionContext != null) {
            ...
            if (webDonationPayments != null) {
                donationPaymentCollectedBatch
                        .setWebDonationPayments(webDonationPayments);
            }
        ...
        Batch batch = Util.getBatchObject(Constant.EVENT_REGISTRATION_PAYMENT_COLLECTED, batchNumber);
        donationPaymentCollectedBatch.setBatch(batch);
        MessageHeader messageHeader = Util.getMessageHeaderObject(Constant.EVENT_REGISTRATION_PAYMENT_COLLECTED);
        donationPaymentCollectedBatch.setMessageHeader(messageHeader);

        try {
            batchDelegate.processEventRegistrationPaymentsCollected(donationPaymentCollectedBatch);
        }
        ...
        LOGGER
                .info("Inside EventRegistrationFeePaymentCollectedUploadListener afterWrite method -Stop");
    }
