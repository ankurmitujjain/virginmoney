 ...
 *         &lt;element name="adminAddress" type="{http://www.virginmoneygiving.com/type/giving-management/common/}ServiceAddress"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CharityAddressRequest")
public class CharityAddressRequest {
    ...
    @XmlElement(required = true)
    protected ServiceAddress adminAddress;
     ...
     *     
     */
    public ServiceAddress getAdminAddress() {
        return adminAddress;
    }
     ...
     *     
     */
    public void setAdminAddress(ServiceAddress value) {
