 ...
 * Test Publish Events
 * 
 * Set up the database with some charities and some unpublished events, then 
 * create a fake message from scheduler to invoke the publish event job. 
 * Check the database is in the expected state afterwards and that the events 
 * have been indexed.
 *
 * @author ian.priest@opsera.com
 */
public class TestPublishEvents {
    ...
    public void setUp() throws Exception {
        ...
        givingDbUnitHelper =
            new DbUnitHelper(
                ...
                "/com/virginmoneygiving/integrationtests/charity/publishevents/giving-after-dataset.xml",
                "/com/virginmoneygiving/integrationtests/charity/publishevents/giving-before-dataset.xml");
        givingDbUnitHelper.getObjectMap().put("[date]", dateString);
    ...
    public void testPublish() throws Exception {
        ...
        // Check the events have been indexed
    ...
    private void sendJmsTextMessage() throws Exception {
        ...
        myMessage.setStringProperty("jobName", "eventPublishJob");
