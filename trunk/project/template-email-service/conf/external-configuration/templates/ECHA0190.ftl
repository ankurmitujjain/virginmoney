...
<p class="style1">We&#39;re really pleased to let you know a new ${fundraiserOrTeamLabel} has 
started supporting your charity through Virgin Money Giving&#58;</p>

<table style="font-size:12px;color:#000000;font-family:verdana;" cellspacing="0" cellpadding="0" border="0" >
<tr><td style="width:240px;"><strong>New fundraiser</strong></td><td>${EDI0070} ${EDI0210}</td></tr>
